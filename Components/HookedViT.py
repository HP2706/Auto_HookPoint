...
"""
This file is a transformerlens extension of ViT models based on https://github.com/xplip/pixel
Original code from https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/modeling_vit.py
But somewhat modified to support hooking into the model and type hints
"""
...
class ViTSelfAttention(AutoHookedRootModule):
    def __init__(self, config : HookedPixelCfg):
    ...
    def forward(
        self, 
        hidden_states : Float[torch.Tensor, 'batch pos d_model'], 
        ...
        self.hook_attn_probs(attention_probs)
